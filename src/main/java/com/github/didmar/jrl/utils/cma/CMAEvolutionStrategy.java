package com.github.didmar.jrl.utils.cma;
...
/* 
 ...
 log of changes: 
     ...
     o variabled locked is set at the end of supplementRemainders, 
 ...
 Last change: $Date: 2010-12-04 14:33:10 +0100 (Sat, 04 Dec 2010) $     
 */
...
public class CMAEvolutionStrategy implements java.io.Serializable {
     ...
     * 
     */
    public final String versionNumber = new String("0.99.30"); 
...
//    }
    ...
    */
	 ...
	 * function values and alternative interface for
     * updateDistribution(double[] functionValues). functionValues is used to establish an ordering 
    ...
    public void updateDistribution(double[][] population, double[] functionValues) {
    	...
    	// TODO: better check whether arx is reasonable, e.g. 
    	// check whether it was 
    	// arx == phenoGenoTransformation(population, null)
    	// before the assignment or similar or permuted?
